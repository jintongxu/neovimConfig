...
* [三、cgdb和gdb的快捷键](#三cgdb和gdb的快捷键)
   ...
   * [gdb](#gdb)
      ...
      * [查询运行信息](#查询运行信息)
      * [查看源代码](#查看源代码)
* [三、个人其他配置使用](#三个人其他配置使用)
   * [3.1 cgdb和gdb的快捷键](#31-cgdb和gdb的快捷键)
      * [cgdb](#cgdb-1)
      * [gdb](#gdb-1)
         * [断点](#断点-1)
         * [打印表达式](#打印表达式-1)
         * [查询运行信息](#查询运行信息-1)
         * [查看源代码](#查看源代码-1)
   * [3.2 lazygit快捷键](#32-lazygit快捷键)
   * [杂](#杂-1)
      * [READEM.md生成toc目录](#reademmd生成toc目录)
